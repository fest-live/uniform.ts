...
Defined in: uniform.ts/src/newer/next/transport/Transport.ts:651
...
new ServiceWorkerTransport(
   channelName, 
   _isHost?, 
   options?): ServiceWorkerTransport;
```

Defined in: uniform.ts/src/newer/next/transport/Transport.ts:654
...
Defined in: uniform.ts/src/newer/next/transport/Transport.ts:658
...
Defined in: uniform.ts/src/newer/next/transport/Transport.ts:668
